package com.example.kafkaconnectorplugins;
...
public class FileSourceTask extends SourceTask {
    ...
    public void start(Map<String, String> props) {
        AbstractConfig config = new AbstractConfig(FileSourceConnector.CONFIG_DEF, props);
        filename = config.getString(FileSourceConnector.FILE_CONFIG);
        ...
        topic = config.getString(FileSourceConnector.TOPIC_CONFIG);
        batchSize = config.getInt(FileSourceConnector.TASK_BATCH_SIZE_CONFIG);
    }
